...
const Footer: FC = () => {
  ...
  return (
    <footer className="w-full mt-20 border-t backdrop-blur-md transition-colors duration-300 light:bg-white/80 light:border-slate-200 dark:bg-slate-900/50 dark:border-white/5">
      <div className="container mx-auto py-8 px-4 flex flex-col items-center gap-6">
              ...
              className={({ isActive }) =>
                `text-sm font-bold tracking-wide transition-all duration-300 hover:-translate-y-1 ${
                  isActive
                    ...
                    : 'light:text-slate-600 light:hover:text-purple-600 dark:text-slate-400 dark:hover:text-cyan-400'
                }`
              }
            >
              {link.title}
        ...
        {/* --- TELİF HAKKI --- */}
        <div className="flex flex-col md:flex-row items-center gap-1 text-sm font-medium light:text-slate-500 dark:text-slate-500">

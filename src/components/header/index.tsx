    ...
    <header className="flex justify-center pt-8 px-4 relative z-50">
      ...
      >
        ...
        <div className="flex-1 min-w-0 flex items-center mr-2 lg:mr-4">
          <Link
            to="/"
            className="group flex items-center text-base sm:text-xl md:text-xl lg:text-3xl font-mono font-bold whitespace-nowrap overflow-hidden text-ellipsis bg-gradient-to-r bg-clip-text text-transparent light:from-cyan-600 light:to-purple-600 dark:from-cyan-400 dark:to-purple-500 hover:opacity-80 transition-opacity"
            aria-label="Ali Okhan - Ana Sayfa"
          >
            <span aria-hidden="true" className="flex items-center">
              <span className="light:text-slate-600 dark:text-slate-400 mr-1 opacity-70 group-hover:text-cyan-500 transition-colors">
                &lt;
              </span>
              ...
              <span className="light:text-slate-600 dark:text-slate-400 ml-1 opacity-70 group-hover:text-purple-500 transition-colors">
                /&gt;
              </span>
            </span>
          </Link>
